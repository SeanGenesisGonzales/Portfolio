...
export default function Certifications() {
  const Certificates = [
    ...
    },
    {
      Image: Module1_2,
      Title:
        "BRIDGE Building Resilient and Inclusive Development through Global Education_Module 1 & 2",
      DateAcquired: "May 20, 2025",
    },
    {
      Image: Module3,
      Title:
        "BRIDGE Building Resilient and Inclusive Development through Global Education_Module 3",
      DateAcquired: "May 20, 2025",
    },
  ];
  ...
  return (
    <div className="h-fit w-[80vw] py-[5vh] gap-[5vh] flex flex-col items-center border-y-2 border-LightMode dark:border-DarkMode">
      <p className="font-extrabold text-5xl   font-[garamond] text-LightMode dark:text-DarkMode">
        Certifications
      </p>
